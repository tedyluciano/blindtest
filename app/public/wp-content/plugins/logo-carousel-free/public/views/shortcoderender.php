	...
	class SPLC_Shortcode_Render {
		...
		public function sp_logo_carousel_render( $attribute ) {
			...
			while ( $args->have_posts() ) :
				...
				$output .= '<div class="swiper-slide"><div class="sp-lc-logo"><img src="' . $lcf_image . '" alt="' . get_the_title() . '" ' . $image_title_attr . ' /></div></div>';
			endwhile;
			wp_reset_postdata();
			$output .= '</div>';
