...
spl_autoload_register( 'atomix_manager_autoload' );
 ...
 */
function atomix_manager_autoload( $class_name ) {

    // If the specified $class_name does not include our namespace, duck out.
    if ( false === strpos( $class_name, 'AtomixManager' ) ) {
        return;
    }
    ...
    if ( file_exists( $filepath ) ) {
        ...
        wp_die(
            esc_html( "Le fichier qui tente d'être chargé à $filepath n'existe pas." )
        );
    }
